...
import com.example.complan.InputProfileActivity
import com.example.complan.MainActivity
import com.example.complan.R
import com.example.complan.databinding.ActivityLoginBinding
    ...
    private fun updateUI(currentUser: FirebaseUser?) {
        if (currentUser != null){
            authReference.child(currentUser.uid).get().addOnSuccessListener{
                if (it.exists()){
                    val o = Intent(this@LoginActivity,  MainActivity::class.java)
                    startActivity(o)
                    finish()
                }else{
